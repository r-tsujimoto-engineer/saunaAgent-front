...
const saunaData = [
  {
    id: 1,
    name: "hogehogeサウナ",
    image: "/images/favorite/recommendationSauna3.jpeg",
    totalTime: "49",
    rating: "4.5",
    material: "高音サウナ",
    congestion: "hogehogehoge"
  },
  {
    id: 2,
    name: "hogehogeスパ",
    image: "/images/favorite/recommendationSauna4.jpeg",
    totalTime: "68",
    rating: "4.7",
    material: "高音サウナ",
    congestion: "hogehogehoge"
...
export const Favorite: React.FC = () => {
  ...
  return (
    <Box className={styles.nearbySauna}>
      <Header icon={<ArrowBackIosNewOutlinedIcon />} title="お気に入り" />
